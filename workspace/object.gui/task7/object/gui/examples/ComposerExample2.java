...
public class ComposerExample2 implements Runnable {

  static ComposerExample2 sample;

  public static void main(String args[]) throws Exception {
    sample = new ComposerExample2(args);
  }
  ...
  class Ticker implements TimerListener {
    ...
    public void expired() {
      ...
      if (now - m_last > 5000) {
        ...
        m_progress += m_delta;
        if (m_count > 50)
          System.out.println(" count=" + m_count + " progress=" + m_progress);
